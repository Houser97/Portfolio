  ...
  return (
    <footer className='app__footer'>
      ...
      <div className='contact-links'>
        ...
        <a href = 'https://github.com/Houser97' className='github-contact contact-link'>
          <svg className='svg-footer' viewBox="0 0 24 24">
        ...
        <a href = 'https://www.linkedin.com/in/arturoa-riverar/' className='github-contact contact-link'>
          <svg className='svg-footer' viewBox="0 0 24 24">
